  ...
  return (
    <section>
      <div className="md:block hidden">
        <div
          ref={domRef}
          className={`absolute mt-36 -left-[470px] ${isVisible ? "translate-x-[220px]" : ""}`}
        ...
        <div
          ref={domRef}
          className={`absolute mt-36 -right-[440px] ${isVisible ? "-translate-x-[220px]" : ""}`}
          style={{ transition: "transform 1s ease-in-out 0.5s" }}
        >
        ...
        <CornerBorderDiv className="left-top-corner right-bottom-corner text-center">
          <div className="md:pl-lg md:pb-[42px] md:pr-xxx-big pt-2">
            ...
            <p className="font-inter mb-x-big text-sm">
              We serve any type of tickets for any type of customers all around the world. Safer, more secure, fun,
              customer journey options, freedom were given venue to customers ticket.
            </p>
          </div>
        </CornerBorderDiv>
      </div>
