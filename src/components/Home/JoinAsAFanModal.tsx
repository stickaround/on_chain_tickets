...
export default function JoinAsAFanModal({ open, closeModal, openConfirmModal }: JoinAsAFanModalProps) {
        ...
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg bg-[#65474D]/80 relative flex flex-col w-full outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
              <h3 className="text-3xl font-semibold">Select tickets</h3>
              <button
            ...
            <div className="relative p-6 flex-auto">
              <div>
                <label className="mb-2 text-lg font-medium text-[#E5E7EB]">Select a ticket</label>
                <div className="grid grid-cols-3 gap-4">
                  <div className={firstSelected ? "bg-gray-500 p-3 rounded-3xl" : ""}>
                    <div
                  ...
                  <div className={secondSelected ? "bg-gray-500 p-3 rounded-3xl" : ""}>
                    <div
                      className="hover:cursor-pointer rounded-3xl p-2 dark:hover:bg-grey-100"
                    ...
                    >
                      <img
                        ...
                        className={`rounded-3xl object-cover hover:scale-105 ${secondSelected ? "border-1" : ""}`}
                        alt="John Mayer"
                        width="200px"
                      />
                    </div>
                  ...
                  <div className={thirdSelected ? "bg-gray-500 p-3 rounded-3xl" : ""}>
                    <div
                      className="hover:cursor-pointer rounded-3xl p-2 dark:hover:bg-grey-100"
                    ...
                    <p className="text-xs ml-3 mt-2 font-normal text-gray-200 dark:text-gray-300">Kobe was a legend</p>
                  </div>
                </div>
              </div>
