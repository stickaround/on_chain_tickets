    ...
    <section className="md:mt-[15px] md:px-[20px] mt-0" id="howitworks">
      ...
      <div className="max-w-[587px] md:mb-xx-sm mb-[80px]">
        ...
        <CornerBorderDiv className="hidden md:block right-top-corner left-bottom-corner md:pl-16 md:pb-16 md:pt-8">
          <div className="md:-mr-16">
            <h2 className="font-bold md:text-d-lg leading-[64px] mb-2 text-center md:text-left text-[45px]">
              <p>
                The next level <br /> of blockchain <span className="text-orange-400">ticketing</span>
              </p>
            </h2>
            <p className="font-inter mb-x-big text-base">
              <span className="italic text-lg mr-[4px] text-amber-400">Onchain ticket</span> is to manage ticketing on
              top of blockchain. Ticket buyers and event organizers who make use of the protocol's products don't need
              to worry about scam; they simply experience a top-notch ticketing experience.
            </p>
            <Button className="px-[60px] py-4" handleClick={() => handleClickDemo("demo")}>
      ...
      <div className="grid grid-cols-2 gap-4 mt-[250px] mb-[200px]" id="demo">
        <div className="block rounded-lg bg-gray-600 shadow-lg dark:bg-neutral-700">
          <img className="rounded-t-lg w-[100%]" src="/assets/venue.jpg" alt="venue" />
          <div className="p-6">
            <Button
        ...
        <div className="block rounded-lg bg-gray-600 shadow-lg dark:bg-neutral-700">
          <img className="rounded-t-lg w-[100%]" src="/assets/fan.jpg" alt="venue" />
          <div className="p-6">
            <Button
      ...
      <DemoModal open={isDemoModalOpen} closeModal={() => setIsDemoModalOpen(false)} />
      <JoinAsAVenueModal open={isJoinAsAVenueModalOpen} closeModal={() => setIsJoinAsAVenueModalOpen(false)} />
      <JoinAsAFanModal
        open={isJoinAsAFanModalOpen}
        closeModal={() => setIsJoinAsAFanModalOpen(false)}
        openConfirmModal={() => setIsConfirmModalOpen(true)}
      />
      <ConfirmCodeModal open={isConfirmModalOpen} closeModal={() => setIsConfirmModalOpen(false)} />
    </section>
  );
};
