          ...
          <FadeInSection>
            <div className=' text-left md:mb-0 mb-6 order-2 md:order-1 bg-[#65474D]/50 rounded-2xl p-7 md:max-w-[280px] md:mt-[145px] md:ml-16'>
              ...
              <p className='mt-4 label-large'>
                ...
                been done before. We are not afraid to make tough choices that
                align with our long-term objectives. We know that it always
          ...
          <FadeInSection>
            <div className='md:mb-0 mb-6 bg-[#65474D]/50 rounded-2xl p-7 md:max-w-[290px] md:mr-[80px] md:mt-[80px]'>
              ...
              <p className='mt-4 label-large'>
                ...
                recognise grit in our colleagues. We understand that building a
                world-changing company is a monumental task, but we love every
                minute of it We celebrate milestones together, recharge, and get
                back to work
              </p>
            </div>
          </FadeInSection>
            ...
            <FadeInSection>
              <div className='bg-[#65474D]/50 rounded-2xl p-7 mx-auto md:max-w-[490px]'>
                ...
                <p className='mt-4 label-large'>
                  We think big, take smart risks, and do things that have never
                  been done before. We are not afraid to make tough choices that
                  align with our long-term objectives. We are all empowered to
                  take initiative, make the right decisions, and act as owners.
                  We are committed to protecting our company culture and seek to
                  bring in the best people we’ve ever worked with. We aim to
                  surprise and inspire with the quality and speed of our
                  decision-making
                </p>
              </div>
            </FadeInSection>
